    ...
    parent: function (e) {
      for (var t = [], a = 0; a < this.length; a += 1)
        null !== this[a].parentNode &&
          (e ? I(this[a].parentNode).is(e) && t.push(this[a].parentNode) : t.push(this[a].parentNode));
      return I(r(t));
    },
    parents: function (e) {
      for (var t = [], a = 0; a < this.length; a += 1)
            ...
            if ("column" === t.slidesPerColumnFill || ("row" === t.slidesPerColumnFill && 1 < t.slidesPerGroup)) {
              if ("column" === t.slidesPerColumnFill)
                (I = P - ($ = Math.floor(P / S)) * S),
                  (M < $ || ($ === M && I === S - 1)) && S <= (I += 1) && ((I = 0), ($ += 1));
              else {
                var L = Math.floor(P / t.slidesPerGroup);
                $ =
                  P -
                  (I = Math.floor(P / t.slidesPerView) - L * t.slidesPerColumn) * t.slidesPerView -
                  L * t.slidesPerView;
              }
              (z = $ + (I * x) / S),
                k.css({
  ...
  var w = {
          ...
          (e.onTouchStart = function (e) {
            ...
            if (!t.animating || !i.preventInteractionOnTransition) {
              ...
              if (
                ...
                if (
                  i.noSwiping &&
                  I(r.target).closest(i.noSwipingSelector ? i.noSwipingSelector : "." + i.noSwipingClass)[0]
                )
                  t.allowClick = !0;
                ...
                if (!a.isTouchEvent || "mousemove" !== n.type) {
                  ...
                  if (!t.allowTouchMove)
                    return (
                      ...
                      void (
                        a.isTouched &&
                        (te.extend(s, { startX: o, startY: l, currentX: o, currentY: l }),
                        (a.touchStartTime = te.now()))
                      )
                    );
    ...
    T = (function (u) {
      function h() {
        ...
        (s =
          (s = 1 === a.length && a[0].constructor && a[0].constructor === Object ? a[0] : ((t = (e = a)[0]), e[1])) ||
          {}),
          (s = te.extend({}, s)),
          t && !s.el && (s.el = t),
          u.call(this, s),
  ...
  var O = {
    ...
    G = {
      ...
      setDragPosition: function (e) {
        var t,
          ...
          l = i.dragStartPos;
        (t =
          (i.getPointerPosition(e) - r.offset()[a.isHorizontal() ? "left" : "top"] - (null !== l ? l : n / 2)) /
          (o - n)),
      ...
      setTranslate: function () {
        ...
        for (var h = 0; h < s.length; h += 1) {
          ...
          if (
            ...
            0 === E.length &&
              ((E = I('<div class="swiper-slide-shadow-' + (p ? "left" : "top") + '"></div>')), v.append(E)),
              0 === S.length &&
                ((S = I('<div class="swiper-slide-shadow-' + (p ? "right" : "bottom") + '"></div>')), v.append(S)),
      ...
      setTranslate: function () {
        for (var e = this, t = e.slides, a = e.rtlTranslate, i = 0; i < t.length; i += 1) {
          ...
          if (
            ...
            0 === p.length &&
              ((p = I('<div class="swiper-slide-shadow-' + (e.isHorizontal() ? "left" : "top") + '"></div>')),
              s.append(p)),
              0 === c.length &&
                ((c = I('<div class="swiper-slide-shadow-' + (e.isHorizontal() ? "right" : "bottom") + '"></div>')),
                s.append(c)),
      ...
      setTranslate: function () {
        for (
          ...
          if ((v.transform(T), (v[0].style.zIndex = 1 - Math.abs(Math.round(m))), n.slideShadows)) {
            ...
            0 === E.length &&
              ((E = I('<div class="swiper-slide-shadow-' + (o ? "left" : "top") + '"></div>')), v.append(E)),
              0 === S.length &&
                ((S = I('<div class="swiper-slide-shadow-' + (o ? "right" : "bottom") + '"></div>')), v.append(S)),
      ...
      onThumbClick: function () {
        ...
        if (t) {
          ...
          if (!((i && I(i).hasClass(e.params.thumbs.slideThumbActiveClass)) || null == a)) {
            var s;
            if (
              ((s = t.params.loop ? parseInt(I(t.clickedSlide).attr("data-swiper-slide-index"), 10) : a), e.params.loop)
            ) {
              var r = e.activeIndex;
    ...
    Z = [
      ...
      },
      {
        ...
        create: function () {
          te.extend(this, {
            lazy: { initialImageLoaded: !1, load: X.load.bind(this), loadInSlide: X.loadInSlide.bind(this) },
          });
        },
        on: {
          beforeInit: function () {
      ...
      },
      {
        ...
        create: function () {
          te.extend(this, {
            fadeEffect: { setTranslate: W.setTranslate.bind(this), setTransition: W.setTransition.bind(this) },
          });
        },
        on: {
          beforeInit: function () {
      ...
      },
      {
        ...
        create: function () {
          te.extend(this, {
            flipEffect: { setTranslate: U.setTranslate.bind(this), setTransition: U.setTransition.bind(this) },
          });
        },
        on: {
          beforeInit: function () {
      ...
      },
      {
        ...
        create: function () {
          te.extend(this, {
            coverflowEffect: { setTranslate: K.setTranslate.bind(this), setTransition: K.setTransition.bind(this) },
          });
        },
        on: {
          beforeInit: function () {
